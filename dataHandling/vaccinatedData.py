...
# https://data.gov.il/dataset/f54e79b2-3e6b-4b65-a857-f93e47997d9c/resource/57410611-936c-49a6-ac3c-838171055b1f/download/vaccinated-per-day-2021-02-16.csv
main_csv_filename = '../data/vaccinated-per-day-2021-02-16.csv'
...
datagov_source_text_vaccinated = 'Israel covid-19 dataset.\nhttps://data.gov.il/dataset/covid-19 Accessed: {}ֿ\n*0-19 percent vaccinated calculated out of population of 16-19.'.format(
    dateFetched)
...
def getPopulationForAgeGroup(age_group, dontIncludeCantvaccinate=True):
    if age_group=='0-19' and dontIncludeCantvaccinate:
        return population16to19*1000
